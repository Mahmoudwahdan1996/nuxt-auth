<template>
  ...
  >
    ...
    <p class="fs-lg fw-semi text-capitalize">verification</p>
    ...
    <form class="row max-md mt-xs" @submit.prevent="verify">
      <div class="col-2">
        <input
          type="text"
      ...
      <div class="col-12 text-center mt-xs">
        <div class="fs-base text-capitalize">resendding code after</div>
        <span>1:50</span>
...
export default {
  ...
  setup() {
    ...
    async function verify() {
      await authStore.verify(payload.value);
      if (!error.value) {
        router.push("/");
      }
    }
